...
public final class AssetManager implements AutoCloseable {
    ...
    private static final String RINKO_APK_PATH = "/system/framework/org.rinko.platform-res.apk";
    ...
    public static void createSystemAssetsInZygoteLocked(boolean reinitialize,
        ...
        try {
            ...
            apkAssets.add(ApkAssets.loadFromPath(RINKO_APK_PATH, ApkAssets.PROPERTY_SYSTEM));
