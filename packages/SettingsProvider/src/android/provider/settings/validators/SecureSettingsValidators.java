...
public class SecureSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Secure.STOCK_FINGERPRINT, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Secure.NETFLIX_SPOOF_MODEL, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Secure.KEY_ATTESTATION_BLOCKING, BOOLEAN_VALIDATOR);
    }
}
